...
One mistake that i made was i accidentally delete my whole commit history when i was trying to remove the .env file....i created a new repo and commit my new code.
